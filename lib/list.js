...
function List(key, options) {
    ...
    // If this list describes a list of subdocuments,
    // store references to parent list and parent field instances
 ...
 * If no options are provided, returns the field at the specified path.
 *
 * @api public
 */
